import"./assets/menu-f265ad14.js";import{S as A,A as M}from"./assets/vendor-f7826fb8.js";window.addEventListener("load",()=>{const e=document.querySelector("a.main-lightbox"),n=document.getElementById("main-picture"),o=n.querySelector("img"),t=n.querySelector("source"),r=document.querySelectorAll("picture.thumbnail"),s=document.querySelector(".lightbox-gallery");let l;function f(i){const c=Array.from(r),a=[...c.slice(i),...c.slice(0,i)];s.innerHTML="",a.forEach(d=>{var I;const b=d.dataset.full,$=((I=d.querySelector("img"))==null?void 0:I.alt)||"",g=document.createElement("a");g.href=b,g.setAttribute("data-gallery","gallery"),g.setAttribute("data-title",$),s.appendChild(g)}),l&&l.destroy(),l=new A('[data-gallery="gallery"]',{captionsData:"title",captionDelay:250})}function h(i){const c=r[i];if(!c)return;const a=c.querySelector("source"),d=c.querySelector("img");t&&a?(t.srcset=a.srcset,t.media=a.media):t&&(t.removeAttribute("srcset"),t.removeAttribute("media")),o.src=d.full,o.alt=d.alt,e.href=c.dataset.full,r.forEach(b=>b.classList.remove("active")),c.classList.add("active"),f(i)}r.forEach((i,c)=>{i.addEventListener("click",a=>{a.preventDefault(),h(c)})}),h(0)});const E=document.getElementById("list-equipment"),S=document.getElementById("selected-equipment"),D=S.querySelector(".selected-equipment "),L=S.querySelector(".icon-close"),C=document.querySelectorAll(".item-equipment");S.addEventListener("click",e=>{e.stopPropagation(),E.classList.toggle("active"),L.classList.toggle("rotated")});C.forEach(e=>{e.addEventListener("click",n=>{n.stopPropagation(),D.textContent=e.textContent,E.classList.remove("active"),L.classList.remove("rotated")})});document.addEventListener("click",()=>{E.classList.remove("active"),L.classList.remove("rotated")});new M(".acc-container",{duration:300});document.querySelectorAll(".tab-btn").forEach(e=>{e.addEventListener("click",()=>{document.querySelectorAll(".tab-btn").forEach(n=>n.classList.remove("active")),document.querySelectorAll(".list-tab").forEach(n=>n.classList.remove("active")),e.classList.add("active"),document.getElementById(e.dataset.tab).classList.add("active")})});const y=document.getElementById("reviewModal"),R=document.getElementById("openModalBtn"),T=document.getElementById("closeModalBtn"),x=document.getElementById("reviewForm"),B=document.getElementById("reviewsContainer"),H=document.getElementById("showMoreBtn"),q=document.getElementById("starRating"),v=new URL("/castle-on-saltovka/assets/icons-e70d3d57.svg",self.location);let m=JSON.parse(localStorage.getItem("reviews"))||[],w=3,u=0;R.onclick=()=>{y.style.display="flex",document.body.style.overflow="hidden"};T.onclick=()=>{y.style.display="none",document.body.style.overflow=""};window.onclick=e=>{e.target==y&&(y.style.display="none",document.body.style.overflow="")};q.innerHTML=Array.from({length:5},(e,n)=>`
  <span data-index="${n}">
