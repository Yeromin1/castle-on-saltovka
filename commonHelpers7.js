        ...
        <ul class="list-reply">
          <li class="item-reply">
            <svg class="icon-reply-btn" width="24" height="24">
              <use href="${d}#icon-subdirectory"></use>
            </svg>
          </li>
          <li class="item-reply">
